...
const firebaseConfig = {
  apiKey: process.env.EXPO_PUBLIC_FIREBASE_API_KEY || 'AIzaSyAHBLDaiNfCb0iWa7Aw7tS3oAffNTbNpxY',
  authDomain: process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN || 'mycitymart-ec4a8.firebaseapp.com',
  projectId: process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || 'mycitymart-ec4a8',
  storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || 'mycitymart-ec4a8.firebasestorage.app',
  messagingSenderId: process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '339593508644',
  appId: process.env.EXPO_PUBLIC_FIREBASE_APP_ID || '1:339593508644:web:2785271ec1d6b93d8225b1',
};
